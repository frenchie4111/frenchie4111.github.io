...
$(function() {
    function isLocalhost() {
        return window.location.hostname === "localhost" ||
            ...
            window.location.hostname === "";  // For local file system
    }
    ...
    ps.each(function() {
        ...
        if (id === "start") {
            ...
            dates[afterStart.length] = lastDate;
            afterStart.push(this);
        }
    });
    ...
    function updatePoem() {
        ...
        $("#poem").append(afterStart[currentPoem].cloneNode(true));
    }
    ...
    $("#next").click(function() {
        console.log("ASSDF");
        currentPoem += 1;
        currentPoem = Math.min(afterStart.length - 1, currentPoem);
        updatePoem();
    });
